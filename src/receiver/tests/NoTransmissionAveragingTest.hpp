...
#ifndef _NOTRANSMISSIONAVERAGINGTEST_HPP
#define _NOTRANSMISSIONAVERAGINGTEST_HPP

#include <RISE/receiver/SignalAveragingStrategy.hpp>
#include <cppunit/extensions/HelperMacros.h>

namespace rise { namespace receiver { namespace tests {
	class NoTransmissionAveragingTest
		: public CppUnit::TestFixture
	{
		CPPUNIT_TEST_SUITE( NoTransmissionAveragingTest );
		...
		class TestAverager :
			virtual public NoTransmissionAveraging
		{
		public:
			wns::Power
