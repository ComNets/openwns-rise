...
#ifndef _OMNIDIRECTIONAL_HPP
#define _OMNIDIRECTIONAL_HPP
...
namespace rise { namespace antenna { namespace pattern { namespace twodimensional {
	...
	public:
		 ...
		 *
		 */
		inline static  OmniDirectional* getInstance() {
			if(!myself)
				myself = new OmniDirectional();
			return myself;
		};
	...
	private:
		static OmniDirectional *myself;
	};
}}}}
#endif // _OMNIDIRECTIONAL_HPP
