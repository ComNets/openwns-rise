...
STATIC_FACTORY_BROKER_REGISTER(Constant, Pathloss, "Constant");

Constant::Constant(const wns::pyconfig::View& config)
    : DistanceIndependent(config),
      value(wns::Ratio::from_dB(config.get<double>("value")))
{}

Constant::~Constant()
{}

wns::Ratio Constant::calculatePathloss(const antenna::Antenna&,
