...
#ifndef _RISE_SCENARIO_PATHLOSS_DISTANCEINDEPENDENT_HPP
#define _RISE_SCENARIO_PATHLOSS_DISTANCEINDEPENDENT_HPP
...
namespace rise { namespace scenario { namespace pathloss {
    ...
    /**
     * @brief Base class for pathloss models, that don't dependent on the distance of source and target.
     */
    class DistanceIndependent : public Pathloss
    {
    protected:
...
#endif // NOT defined _RISE_SCENARIO_PATHLOSS_DISTANCEINDEPENDENT_HPP
