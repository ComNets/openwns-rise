...
srcFiles = [
    ...
    'src/scenario/PropagationModel.cpp',
    ...
    'src/scenario/fastfading/Jakes.cpp',
    'src/scenario/fastfading/PerLinkAndSC.cpp',
    'src/scenario/fastfading/Freq2SubchannelCache.cpp',
    ...
    'src/scenario/fastfading/jakes/JakesFadingGenerator.cpp',
    'src/scenario/fastfading/jakes/FTFading.cpp',
    ...
    'src/scenario/fastfading/jakes/tests/FTFadingTest.cpp',
    ]
...
hppFiles = [
    ...
    'src/scenario/pathloss/ILoSDependent.hpp',
    ...
    'src/scenario/PropagationModel.hpp',
    'src/scenario/fastfading/jakes/FTFading.hpp',
    'src/scenario/fastfading/jakes/JakesFadingGenerator.hpp',
    'src/scenario/fastfading/NoFastFading.hpp',
    'src/scenario/fastfading/FastFading.hpp',
    'src/scenario/fastfading/RiceFading.hpp',
    'src/scenario/fastfading/Jakes.hpp',
    'src/scenario/fastfading/PerLinkAndSC.hpp',
    'src/scenario/fastfading/Freq2SubchannelCache.hpp',
